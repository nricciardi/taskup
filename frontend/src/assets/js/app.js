(function(ft) {
      ...
      (function(f, r) {
          ...
          return function(a) {
              ...
              "./node_modules/core-js/internals/define-iterator.js": function(a, f, r) {
                  ...
                  a.exports = function($, z, de, yt, Te, sn, Lt) {
                      s(de, z, yt);
                      var Oe = function(ue) {
                          ...
                          Ee, Se, Ie;
                      if (Dt && (Ee = u(Dt.call(new $)), O !== Object.prototype && Ee.next && (!w && u(Ee) !== O && (h ? h(Ee, O) : typeof Ee[j] != "function" && g(Ee, j, L)), p(Ee, mt, !0, !0), w && (_[mt] = L))), Te == N && _e && _e.name !== N && (Qe = !0, ge = function() {
                              return _e.call(this)
  ...
  (function(G, k) {
      (function(a, f) {
          ...
          class tt extends pe {
              ...
              _directionToOrder(e) {
                  return L() ? e === et ? qe : _t : e === et ? _t : qe
              }
              _orderToDirection(e) {
              ...
              if (K) {
                  if (c) {
                      var ie, Fe = V === "y" ? te : ne,
                          ...
                          tn = De[Ye],
                          Ue = At(0, U[se], ht[se]),
                          kn = Q ? U[se] / 2 - qt - Ue - Mt - Z.mainAxis : Hn - Ue - Mt - Z.mainAxis,
                          sc = Q ? -U[se] / 2 + qt + Ue + tn + Z.mainAxis : St + Ue + tn + Z.mainAxis,
                          zn = e.elements.arrow && bt(e.elements.arrow),
                          ac = zn ? V === "y" ? zn.clientTop || 0 : zn.clientLeft || 0 : 0,
                          hr = (ie = ee == null ? void 0 : ee[V]) != null ? ie : 0,
                          lc = me + kn - hr - ac,
                          cc = me + sc - hr,
                          fr = At(C ? kt(Jt, lc) : Jt, me, C ? Re(Ge, cc) : Ge);
                      K[V] = fr, ye[V] = fr - me
                  }
                  if (y) {
                      var yr, dc = V === "x" ? te : ne,
                          ...
                          Er = C && Wn ? Wo(xr, Xe, _r) : At(C ? xr : mr, Xe, C ? _r : gr);
                      K[W] = Er, ye[W] = Er - Xe
                  }
                      ...
                      C = {
                          ...
                          setOptions: function(Y) {
                              ...
                              P(), A.options = Object.assign({}, c, A.options, X), A.scrollParents = {
                                  reference: Pe(y) ? wt(y) : y.contextElement ? wt(y.contextElement) : [],
                                  popper: wt(b)
                              };
                          ...
                          forceUpdate: function() {
                              if (!R) {
                                  ...
                                  if (Ci(X, Q)) {
                                      A.rects = {
                                          reference: ys(X, bt(Q), A.options.strategy === "fixed"),
                                          popper: xn(Q)
          ...
          class he extends pe {
              ...
              _selectMenuItem({
                  ...
                  i.length && yt(i, t, e === Ii, !i.includes(t)).focus()
              }
              static jQueryInterface(e) {
                  return this.each(function() {
          ...
          class ze extends pe {
              ...
              hide() {
                  ...
                  this._activeTrigger[qa] = !1, this._activeTrigger[Dn] = !1, this._activeTrigger[jt] = !1, this._isHovered = null;
                  const i = () => {
              ...
              _setListeners() {
                  ...
                  for (const t of e)
                      ...
                      const i = t === jt ? this.constructor.eventName(cl) : this.constructor.eventName(al),
                          o = t === jt ? this.constructor.eventName(dl) : this.constructor.eventName(ll);
                      x.on(this._element, i, this._config.selector, c => {
                          const d = this._initializeOnDelegatedTarget(c);
                          d._activeTrigger[c.type === "focusin" ? Dn : jt] = !0, d._enter()
                      }), x.on(this._element, o, this._config.selector, c => {
                          const d = this._initializeOnDelegatedTarget(c);
                          d._activeTrigger[c.type === "focusout" ? Dn : jt] = d._element.contains(c.relatedTarget), d._leave()
                      })
                  }
          ...
          x.on(window, bl, () => {
              for (const n of I.find(wl)) Tt.getOrCreateInstance(n)
          }), $(Tt);
          const Nl = "tab",
              We = ".bs.tab",
              Ll = `hide${We}`,
          ...
          class Be extends pe {
              ...
              _keydown(e) {
                  ...
                  const t = [lr, cr].includes(e.key),
                      i = yt(this._getChildren().filter(o => !v(o)), e.target, t, !0);
                  i && (i.focus({
                      preventScroll: !0
  ...
  class Or {
      ...
      onResize() {
          Ct(window) ? this.sidebarEL.classList.add("active") : this.sidebarEL.classList.remove("active"), this.deleteBackdrop(), this.toggleOverflowBody(!0)
      }
      toggle() {
  ...
  const Bn = G => {
      if(G == null) {
        console.log("E: null problem");
      }

      Ct(window) && (G.classList.add("active"), G.classList.add("sidebar-desktop"));
  ...
  const loadMenu = () => {
    let Nt = document.getElementById("sidebar");
    document.readyState !== "loading" ? Bn(Nt) : window.addEventListener("DOMContentLoaded", () => Bn(Nt)), Nt && (window.sidebar = new Or(Nt)), window.bootstrap = Tr, wr.replace()
